...
1. Determine the namespace. If it was already provided (e.g. this skill was invoked from `/setup-ib` with a namespace decided), use that and don't re-ask. Otherwise ask: "What namespace should this vault start with? (e.g. 'personal', 'work', 'research')"
